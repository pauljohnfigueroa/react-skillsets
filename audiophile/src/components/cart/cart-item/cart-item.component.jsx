...
const CartItem = ({ cartItem }) => {
    ...
    const removeITemFromCartHandler = (cartItem) => removeITemToCart(cartItem);
    const clearItemFromCartHandler = (cartItem) => addItemToCart(cartItem);
                    ...
                    <div className="item-details">
                        ...
                        <form action="#">
                            <div className="quantity-nav">
                                <div className="quantity-button quantity-down" onClick={removeITemFromCartHandler(cartItem)}>-</div>
                            </div>
                            <input type="number" min="0" value={cartItem.quantity} className="quantity" />
                            <div className="quantity-nav">
                                <div className="quantity-button quantity-up" onClick={clearItemFromCartHandler(cartItem)}>+</div>
                            </div>
                        </form>
                    </div>
                    <div>
