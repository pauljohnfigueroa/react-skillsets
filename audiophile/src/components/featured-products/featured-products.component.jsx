        ...
        <>
            <section class="featured-products-section">
                <div class="featured-product-1">
                    ...
                    <div class="featured-product-texts">
                        <h2 class="featured-product-heading">{featuredProducts[0].heading}</h2>
                        <p class="featured-product-subtext">{featuredProducts[0].subText}</p>
                        <div class="featured-product-button"><a href="#">See Product</a></div>
                    </div>
                </div>
                ...
                <div class="featured-product-3">
                    ...
                    <div class="featured-product-texts-container">
                        <div class="featured-product-texts">
                            <h2 class="featured-product-heading">{featuredProducts[2].heading}</h2>
                            <div class="featured-product-button"><a href="#">See Product</a></div>
                        </div>
                    </div>
                </div>
